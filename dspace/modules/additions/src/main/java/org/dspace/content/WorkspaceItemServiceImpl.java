...
import org.dspace.lrs.LrsUtils;
...
public class WorkspaceItemServiceImpl implements WorkspaceItemService {
    ...
    public WorkspaceItem create(Context context, Collection collection, boolean template) throws AuthorizeException, SQLException {
        ...
        LrsUtils.sendCreateNewSubmissionStatement(context.getCurrentUser().getID().toString(), context.getCurrentUser().getEmail(), collection.getName(),collection.getID().toString(),item.getID().toString());
    ...
    public void update(Context context, WorkspaceItem workspaceItem) throws SQLException, AuthorizeException {
        ...
        /*Send statement to lrs*/
       // LrsUtils.sendUpdateSubmissionStatement(context.getCurrentUser().getID().toString(), context.getCurrentUser().getEmail(),workspaceItem.getCollection().getName(),workspaceItem.getCollection().getID().toString(),workspaceItem.getItem().getID().toString());
    ...
    public void deleteAll(Context context, WorkspaceItem workspaceItem) throws SQLException, AuthorizeException, IOException {
        ...
        /*Send statement to lrs*/
        LrsUtils.sendDeleteSubmissionStatement(context.getCurrentUser().getID().toString(), context.getCurrentUser().getEmail(),workspaceItem.getCollection().getName(),workspaceItem.getCollection().getID().toString(),item.getID().toString());
